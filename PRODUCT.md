...
- State the central result plainly: across region-level planning, neuron-level planning with plasticity, and associative-memory tests, on the female adult, male adult and larval brains, the measured wiring has not yet beaten its relevant null model under the implemented harnesses.
