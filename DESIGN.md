...
The navigation is a sticky 4.5rem carbon masthead with a slab-serif civic-yellow wordmark, uppercase supporting label, ruled section links, and a civic-yellow console action. Hover changes ordinary links to soft civic yellow and lightens the console action. An oxblood “Fund the Research” box with a small caret sits before the console action. Hovering it, or activating it by click, tap or keyboard, drops a square bright-paper panel with a 0.25rem oxblood top rule and the raised-evidence shadow; it lists the Solana and EVM wallets in full, in the data face, each with a carbon copy button. Escape, a click outside or tabbing away closes it. The masthead sheds items in stages so it never runs past the viewport: at 80rem and below the supporting label hides and link padding tightens; at 68rem and below the GitHub link hides; at 64rem and below the research-section links hide while the brand, community link, funding box and console action remain; at 52rem and below the funding panel anchors to the masthead’s right edge; at 35rem and below the console action hides; below 28rem the masthead reduces to 4rem and the community link narrows to 3rem; below 22rem the funding label shortens to “Fund” while its accessible name stays “Fund the Research”.
