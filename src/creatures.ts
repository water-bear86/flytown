...
export function makeGoblin(personality: Personality = "nerdy"): Creature {
  return {
    kind: "goblin",
    modelSlot: "goblin",
    model: activeModelForSlot("goblin", "gpt-5-mini"),
    temperature: 0.9,
    personality,
    systemPrompt:
...
export function makeGremlin(personality: Personality = "feral"): Creature {
  return {
    kind: "gremlin",
    modelSlot: "gremlin",
    model: activeModelForSlot("gremlin", "gpt-5-mini"),
    temperature: 1.1,
    personality,
    systemPrompt:
...
export function makeRaccoon(personality: Personality = "stoic"): Creature {
  return {
    kind: "raccoon",
    modelSlot: "raccoon",
    model: activeModelForSlot("raccoon", "gpt-5-mini"),
    temperature: 0.4,
    personality,
    systemPrompt:
...
export function makeOgre(personality: Personality = "stoic"): Creature {
  return {
    kind: "ogre",
    modelSlot: "ogre",
    model: activeModelForSlot("ogre", "gpt-5"),
    temperature: 0.3,
    personality,
    systemPrompt:
...
export function makePigeon(personality: Personality = "chipper"): Creature {
  return {
    kind: "pigeon",
    modelSlot: "pigeon",
    model: activeModelForSlot("pigeon", "gpt-5-mini"),
    temperature: 0.5,
    personality,
    systemPrompt:
